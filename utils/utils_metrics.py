...
def fast_hist(a, b, n):
    #--------------------------------------------------------------------------------#
    #   a is the label transformed into a one-dimensional array with shape (H×W,)
    #   b is the predicted result transformed into a one-dimensional array with shape (H×W,)
    #--------------------------------------------------------------------------------#
    k = (a >= 0) & (a < n)
    #--------------------------------------------------------------------------------#
    #   np.bincountcounts the number of occurrences of each of the n**2 numbers from 0 to n**2-1
    #--------------------------------------------------------------------------------#
...
def compute_mIoU(gt_dir, pred_dir, png_name_list, num_classes, name_classes):  
    ...
    for ind in range(len(gt_imgs)): 
        ...
        label = Image.open(gt_imgs[ind]).resize((pred.shape[1], pred.shape[0]), Image.NEAREST)
